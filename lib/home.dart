...
var image=['assets/icons8-male-user-24.png','assets/image/download (3).png','assets/image/download (2).png','assets/image/download (1).png'];
        ...
        child: Padding(
          ...
          child: Column(
           ...
           children: [ Padding(
             ...
             color: Color.fromARGB(255, 22, 49, 72)),),
           ),
          Padding(
            padding: const EdgeInsets.only(left: 30),
            child: Text('Good day ahead !',
            style: TextStyle(fontSize: 25,
             color: Color.fromARGB(255, 21, 51, 76)),
            ),
          ),
         Padding(
           ...
           child: Container(
            height: 500,
            width: double.infinity,
            color: const Color.fromARGB(255, 209, 200, 173).withOpacity(0.1),
